# Generated by Django 4.2.17 on 2025-01-10 16:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perm_level', models.IntegerField(choices=[(0, 'None'), (1, 'Admin'), (2, 'Manager'), (3, 'Funcionário')])),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'hashed_password'), name='unique_user_hashed_password'),
        ),
    ]
